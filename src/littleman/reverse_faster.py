...
def build_reverse_faster() -> str:
    ...
    # input: I room top wall -> relay floor col 1 (sorts before ring-out's
    # col 3 terminal, which is what gives input spatial priority at `R`).
    ...
    # ring-out: pump floor -> snake (capacity 16) -> relay floor col 3.
    canvas.pipe(
        [
