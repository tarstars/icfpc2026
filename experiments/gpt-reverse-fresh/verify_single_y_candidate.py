"""Reproduce and verify the solver-derived 20-square single-Y candidate."""
...
ROOT = HERE.parents[1]
ARTIFACT = HERE / "reverse_fresh_20.man"
GENERATOR = HERE / "build_single_y_candidate.py"
PROBLEM_PATH = ROOT / "data/small/problems/reverse-a-list.json"
EXPECTED_SHA256 = "a94a74bc0d422648579f718a6221aff10e0d22dc0eb397751f721457f59ae28d"
EXPECTED_PUBLIC_TICKS = [148, 85, 134, 211, 120, 127, 253, 393]
...
def run_wasm(cases: list[dict], max_ticks: int = 20_000) -> list[dict]:
    request = {
